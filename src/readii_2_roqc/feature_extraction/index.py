...
def generate_dataset_index(dataset: str, 
    ...
    readii_settings = dataset_config['READII']['IMAGE_TYPES']
    readii_regions = readii_settings['regions']
    readii_permutations = readii_settings['permutations']

    if readii_regions and readii_permutations:
