...
class ProjectDirs(DmpDirs):
    """
    Defines project-specific directories managed by damply.
    These directories are used throughout the project for consistent path management.
    """
    LOGS: Path = 'logs'
